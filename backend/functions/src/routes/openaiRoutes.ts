...
const updateHomepageHandler = async (req: UpdateHomepageRequest, res: Response) => {
  ...
  try {
    ...
    if (toolCall?.function?.name === "update_homepage") {
      ...
      // Combine the success message with the generated text
      const successMessage = `Homepage updated successfully with:\n\n${sanitizedText}`;
